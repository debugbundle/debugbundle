...
function buildLlmsTxt(): string {
  return ensureTrailingNewline(
    [
      ...
      `- iOS SDK: ${toAbsoluteUrl('/docs/sdks/swift/')}`,
      ...
      `- AnalyticsBundle: ${toAbsoluteUrl('/docs/analytics/')}`,
      `- AnalyticsBundle privacy: ${toAbsoluteUrl('/docs/analytics/privacy/')}`,
      `- Self-hosted AnalyticsBundle: ${toAbsoluteUrl('/docs/analytics/self-hosting/')}`,
      `- AnalyticsBundle CLI: ${toAbsoluteUrl('/docs/cli/analytics/')}`,
      `- AnalyticsBundle API: ${toAbsoluteUrl('/docs/api/analytics/')}`,
      '',
