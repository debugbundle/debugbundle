export const CLI_USAGE_LINES = [
  ...
  '  DEBUGBUNDLE_AGENT_TOKEN=<credential> debugbundle agent connect [--base-url <url>] [--auth-file <path>]',
  '  debugbundle agent project_summary <project-id> [--auth-file <path>]',
  '  debugbundle agent list_incidents <project-id> [--limit <n>] [--cursor <cursor>] [--auth-file <path>]',
  '  debugbundle agent get_incident <project-id> <incident-id> [--auth-file <path>]',
  '  debugbundle agent get_incident_context <project-id> <incident-id> [--auth-file <path>]',
  '  debugbundle agent get_bundle <project-id> <incident-id> [--auth-file <path>]',
  ...
  '  debugbundle analytics settings set --project <id> [--enabled <true|false>] [--privacy-mode <strict|standard|custom>] [--consent-required <true|false>] [--capture-page-views <true|false>] [--capture-route-changes <true|false>] [--capture-actions <true|false>] [--capture-friction-signals <true|false>] [--journey-sample-rate <0-1>] [--raw-retention-days <n>] [--sample-retention-days <n>] [--hourly-retention-days <n>] [--aggregate-retention-months <n>] [--max-saved-funnels <n>] [--max-custom-dimensions <n>] [--approved-custom-dimensions <key[,key]> | --approved-custom-dimensions-json <json>] [--auth-file <path>] [--json]',
  '  debugbundle analytics saved-funnels list --project <id> [--auth-file <path>] [--json]',
  '  debugbundle analytics saved-funnels create --project <id> --key <key> --name <name> --steps-json <json> [--auth-file <path>] [--json]',
  '  debugbundle analytics saved-funnels update <key> --project <id> [--name <name>] [--steps-json <json>] [--auth-file <path>] [--json]',
  '  debugbundle analytics saved-funnels archive <key> --project <id> [--auth-file <path>] [--json]',
  ...
  '  analytics metric filters: [--route <path>] [--device-type <type>] [--browser <name>] [--os <name>] [--language <code>] [--country <code>] [--auth-state <anonymous|authenticated|unknown>] [--referrer <domain>] [--utm-source <value>] [--utm-medium <value>] [--utm-campaign <value>] [--custom-dimensions-json <json>]',
  '  debugbundle analytics opportunities (--project <id> | --all-projects) [--status <open|resolved|snoozed|all>] [--kind <kind>] [--service <name>] [--environment <name>] [--severity <low|medium|high>] [--bundle-status <not_requested|pending|running|completed|failed>] [--from <ISO8601>] [--to <ISO8601>] [--cursor <cursor>] [--limit <n>] [--auth-file <path>] [--json]',
  '  debugbundle analytics opportunity get <opportunity-id> --project <id> [--auth-file <path>] [--json]',
  '  debugbundle analytics bundle list (--project <id> | --all-projects) [--status <all|pending|running|completed|failed>] [--kind <kind>] [--service <name>] [--environment <name>] [--from <ISO8601>] [--to <ISO8601>] [--cursor <cursor>] [--limit <n>] [--auth-file <path>] [--json]',
  '  debugbundle analytics bundle create --project <id> --kind <kind> [--opportunity-id <id>] [--from <ISO8601>] [--to <ISO8601>] [--last <duration>] [--funnel <key>] [--route <path>] [--incident-id <id>] [--deploy-id <id>] [--filters-json <json>] [--auth-file <path>] [--json]',
  ...
  '  debugbundle token agent list <project-id> [--auth-file <path>] [--json]',
  '  debugbundle token agent create <project-id> --label <label> [--expires-at <ISO8601>] [--auth-file <path>] [--json]',
  '  debugbundle token agent revoke <project-id> <token-id> [--auth-file <path>] [--json]',
  ...
  '  debugbundle alert update <alert-id> --project-id <id> [--service-id <id|null>] [--channel <channel>] [--condition <condition>] [--severity-min <level|null>] [--severity-lifecycle-scope <new_incident|incident_regressed|both|null>] [--cooldown <seconds>] [--config-json <json|null>] [--rotate-signing-secret <true|false>] [--is-enabled <true|false>] [--auth-file <path>] [--json]',
  '    Email config supports aggregation_window_seconds (1-300, default 10); other channels support cooldown_scope (incident or project, isolated by environment/severity).',
