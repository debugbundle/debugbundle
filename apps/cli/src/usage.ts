export const CLI_USAGE_LINES = [
  ...
  '  debugbundle analytics opportunities (--project <id> | --all-projects) [--status <open|resolved|snoozed|all>] [--kind <kind>] [--cursor <cursor>] [--limit <n>] [--auth-file <path>] [--json]',
  '  debugbundle analytics opportunity get <opportunity-id> --project <id> [--auth-file <path>] [--json]',
  '  debugbundle analytics bundle list (--project <id> | --all-projects) [--status <all|pending|running|completed|failed>] [--kind <kind>] [--cursor <cursor>] [--limit <n>] [--auth-file <path>] [--json]',
