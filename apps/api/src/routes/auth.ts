...
import type { AuditLogActorType } from "../../../../packages/storage/src/index.js";
...
import { registerBrowserAuthRoutes } from "./auth-browser.js";
import {
...
export function registerAuthRoutes(app: FastifyInstance, dependencies: ApiDependencies): void {
  ...
  registerBrowserAuthRoutes(app, dependencies, {
    ...
    buildClearedReviewGrantCookie,
    shouldUseSecureCookies,
    isDevGithubMockEnabled
  });
