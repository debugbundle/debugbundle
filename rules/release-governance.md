...
### Gemini CLI Developer Extension
...
This release discipline was rechecked on 2026-09-05 against the current official OpenAI [plugin guidelines](https://developers.openai.com/plugins/app-guidelines), [security and privacy guidance](https://developers.openai.com/plugins/guides/security-privacy), [plugin submission](https://developers.openai.com/plugins/deploy/submission), and [MCP server review](https://developers.openai.com/plugins/deploy/app-review) requirements. Those documents remain the external source for privacy disclosures and restricted data, portal permissions, verified publisher identity, universal production URLs, scan contents, reviewer access, review lifecycle, and the distinction between approval and publication; this repository's stricter owner-approval gates still apply. Revalidate again if submission occurs after 2026-09-12 or the live portal differs.
