...
| 7 | `/docs/sdks/swift` | iOS SDK | Guide | Full guide: install through Swift Package Manager, SwiftUI and UIKit init, URLSession/Alamofire, offline queueing, SwiftLog, crash replay, capture policy, probes, and privacy defaults. |
