...
- **Owns:** All Zod schemas, TypeScript type exports, enums, constants, **tier capabilities config**, **event class enum**, **capture policy types**, **capture rule types and suggestion logic**, **improvement settings types**, and the canonical preset-aware plus status/path-override-aware request-failure classifier used by ingestion, workers, and SDKs
