...
- **Internal structure:**
  ...
  - `routes/analytics-saved-funnels.ts` — paid-tier project saved-funnel list/create/update/archive surface with member reads, owner/admin mutations, shared schemas, and configuration audit records
