...
- **Internal structure:**
  ...
  - `analytics-journey-sample-store.ts` — retained redacted journey sample metadata reservation, artifact-complete marking, list/detail reads, and project-scoped cleanup helpers; public reads only expose rows after artifact persistence completes
