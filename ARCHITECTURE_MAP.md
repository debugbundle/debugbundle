...
- **Internal structure:**
  ...
  - `account-analytics-store.ts` — Postgres deletion-safe account analytics ledger, internal month/year/lifetime query helpers, retained-row backfill, and payment/provider retention snapshot persistence for deleted accounts
