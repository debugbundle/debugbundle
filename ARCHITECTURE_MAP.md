...
- **Jobs:** `normalize-events`, `aggregate-analytics-events`, `group-incident`, `build-bundle`, `build-reproduction`, `evaluate-alerts`, `deliver-alert-email-digest`, `deliver-operational-email`, `deliver-webhook`, `generate-weekly-report`, `cleanup-retention`, `dispatch-github`
