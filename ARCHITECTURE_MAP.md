...
- **Internal structure:**
  ...
  - `openai-mcp-http.ts` / `openai-mcp-dependencies.ts` / `openai-mcp-operations.ts` / `openai-mcp-projections.ts` / `openai-rate-limits.ts` — canonical-host stateless Streamable HTTP, protected-resource/challenge/readiness routes, OAuth principal validation, dedicated readers, strict projection, admission/rates/timeout/output bounds, and metadata-only telemetry
