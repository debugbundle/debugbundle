...
apps/
  ...
  web/           — React + Vite SPA on app.debugbundle.com (implemented auth/account + workspace Health Status + project-settings + projects/project-members with collaborator self-leave + project-tokens + project-probes + project-webhooks + project-alerts + billing slices, reusable shadcn-based UI)
