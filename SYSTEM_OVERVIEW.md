...
packages/
  storage/       — Storage adapters and domain persistence
    src/
      ...
      metadata-store.ts      — Postgres metadata store (incidents, projects, tokens, probes, alerts, and project dashboard metrics that floor monthly raw ingestion against durable project counters)
