...
packages/
  ...
  — Wave 2/3 SDKs (C#, Kotlin, Swift, Rust, Dart, React Native) → separate repos per spec/sdk-language-targets.md; detailed plans currently live in spec/sdks/csharp-sdk.md, spec/sdks/kotlin-sdk.md (Kotlin Android), and spec/sdks/swift-sdk.md (Swift iOS)
